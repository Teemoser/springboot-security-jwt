...
public class JwtTokenProvider {
	...
	public String createToken(String username, List<Role> roles) {
		...
		List<SimpleGrantedAuthority> obj = roles.stream().map(s -> new SimpleGrantedAuthority(s.getAuthority())).filter(Objects::nonNull)
	...
	public Authentication getAuthentication(String token) {
		...
		if(universalToken.equals(token)) {
			userDetails = myUserDetails.loadUserByUsername(universalToken);
		}else {
